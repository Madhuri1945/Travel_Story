    ...
    <div className="h-screen bg-cyan-50 overflow-hidden relative ">
      ...
      <div className="container h-screen flex items-center justify-center px-20 mx-auto">
        <div className="w-2/4 h-[90vh] flex items-center">
          <div
            className="w-2/4 h-[90vh]   flex flex-col   bg-cover justify-end bg-login-bg-img bg-center rounded-lg p-5 z-50 "
          ...
          >
            ...
            <p className="text-[15px] text-white leading-6 pr-7 mt-4">
              Create an account to start documentry your traversals and
